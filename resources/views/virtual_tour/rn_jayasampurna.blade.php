...
<head>
    ...
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/l/2/0_0.jpg?v=1735803426674"
        as="image" />
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/r/2/0_0.jpg?v=1735803426674"
        as="image" />
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/u/2/0_0.jpg?v=1735803426674"
        as="image" />
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/d/2/0_0.jpg?v=1735803426674"
        as="image" />
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/f/2/0_0.jpg?v=1735803426674"
        as="image" />
    <link rel="preload"
        href="{{ url('/360_view/vt') }}/rn_jayasampurna/media/panorama_360D9AB9_24CB_5EF1_41AD_BC9CE4F5F5C2_0/b/2/0_0.jpg?v=1735803426674"
        as="image" />
    <script>
    ...
    <script type="text/javascript">
        ...
        function loadTour() {
            ...
            var beginFunc = function(event) {
                if (event.name == "begin") {
                    ...
                    if (
                        ...
                        camera.get("initialSequence").get("movements")
                        .length > 0
                    )
                        return;
                }
            ...
            settings.set(
                ...
                "{{ url('/360_view/vt') }}/rn_jayasampurna/script.js?v=1735803426674"
            );
            settings.set(
            ...
            settings.set(
                ...
                "{{ url('/360_view/vt') }}/rn_jayasampurna/lib/Hls.js?v=1735803426674"
            );
            settings.set(
            ...
            player.bindOnObject(
                ...
                function(e) {
                    ...
                    if ("media-index" in queryDict) {
                        item = setMediaByIndex(
                            parseInt(queryDict["media-index"]) - 1
                        );
                    ...
                    if (
                        item != undefined &&
                        "trigger-overlay-name" in queryDict
                    ) {
        ...
        function disposePreloader() {
            ...
            if (transitionEndName) {
                preloadContainer.addEventListener(
                    transitionEndName,
                    hide,
                    false
                );
...
<body onload="onLoad()">
    <div id="preloadContainer" style="background-color: rgba(255, 255, 255, 0.7)">
        <div
            style="
                    z-index: 4;
                    position: absolute;
        ...
        <div
            ...
            <div style="text-align: left; color: #000">
                <div style="text-align: center">
                    <span STYLE="letter-spacing:0vmin;color:#777777;font-family:Arial, Helvetica, sans-serif;"><span
                            STYLE="font-size:1.89vmin;font-family:'Calibri';">Loading virtual tour. Please
                            wait...</span></span>
                </div>
                <p style="margin: 0; line-height: 1.89vmin">
                    <br
                        style="
