...
<!-- Main Style CSS -->
<link rel="stylesheet" href="{{ url('/assets/css/custom') }}/style.css?v={{ time() }}" type="text/css" media="all">
<!-- Dropdown CSS -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end text-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ asset('assets/Booking_Mandiri.pdf') }}" download="Booking_Mandiri" type="button">Panduan</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-12">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#kprSubsidi" type="button" role="tab" aria-controls="kprSubsidi" aria-selected="true">KPR Subsidi</button>
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#kprKormersil" type="button" role="tab" aria-controls="kprKormersil" aria-selected="false">KPR Kormersil</button>
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#onlyCash" type="button" role="tab" aria-controls="onlyCash" aria-selected="false">Cash</button>
                                </div>
                            </nav>
                            @if ($id_project == 70)
                            <div class="tab-content  mt-4" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="kprSubsidi" role="tabpanel" aria-labelledby="kprSubsidi-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="kprKormersil" role="tabpanel" aria-labelledby="kprKormersil-tab" tabindex="0">
                                    <div id="opsi-bayar-container">
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                                <p class="m-0">Cicilan 15 Tahun</p>
                                ...
                                <div class="tab-pane fade" id="onlyCash" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                                    <div id="opsi-bayar-container">
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                                <p class="m-0">Cash</p>
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(194500000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(204225000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(212005000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="onlyCash" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                                    <div id="opsi-bayar-container">
                                        <div class="item-opsi px-3 py-2">
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(174000000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(182500000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                        <div class="item-opsi px-3 py-2">
                                            <div>
                                            ...
                                            <div class="text-end">
                                                <strong class="m-0">{{ str_replace(',00', '', Number::currency(189500000 ?? 0, in: 'IDR', locale: 'id_ID')) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bonus-container">
                        <div class="card card-bonus text-center">
                            <div class="card-bonus-body">
                                <img src="{{ url('/assets') }}/images/icon/pagar.png" alt="" width="45px" height="45px">
                                <h5>Pagar</h5>
                        ...
                        <div class="card card-bonus text-center">
                            <div class="card-bonus-body">
                                <img src="{{ url('/assets') }}/images/icon/wall.png" alt="" width="45px" height="45px">
                                <h5>Tembok Dapur</h5>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="tempat-container">
                        ...
                        <div class="item-tempat" onclick="getDekatDengan('{{ $category_id }}')" style="cursor: pointer">
                            <div>
            ...
            <div class="row">
                <div class="col-12">
                    <select class="select-blok" name="blok" id="blok">
                        ...
                        <option value="{{ $blok->blok }}" data-harga="{{ $blok->terima_kunci }}" data-nominal="{{ $blok->nominal_booking }}" data-dp="{{ $blok->dp }}" data-harga_tanah="{{ $blok->harga_tanah }}" data-biaya_pagar="{{ $blok->biaya_pagar }}" data-biaya_tembok="{{ $blok->biaya_tembok }}" data-biaya_ipl="{{ $blok->biaya_ipl }}" data-biaya_hook="{{ $blok->biaya_hook }}" data-biaya_kelebihan_tanah="{{ $blok->biaya_kelebihan_tanah }}" data-biaya_bphtb="{{ $blok->biaya_bphtb }}" data-total="{{ $blok->total }}" data-potongan="{{ $blok->potongan }}" data-total_all="{{ $blok->total_all }}">Blok
                    ...
                    <form class="form-booking" id="formBooking">
                        ...
                        <div class="row py-2">
                            <div class="col-12" id="potonganAwal">
                                <button type="button" id="btn-potongan" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#agreementModal">
...
<!-- sweetalert2 -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.15.9/dist/sweetalert2.all.min.js" integrity="sha256-zXU3hnKwOJq62DswpQcW5m0q0zoQY4UpTLYdmlxwJHg=" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.15.9/dist/sweetalert2.min.css" integrity="sha256-HivoIIkMGPypkWBoBzUEFAY/RZqAWSWLqW/MQFMBRXg=" crossorigin="anonymous">
