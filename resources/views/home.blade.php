            ...
            <div class="col">
                <div class="container-fluid">
                    <div class="row justify-content-center align-items-center g-4 text-white">
                        <div class="col-12 col-lg-3 d-flex flex-column justify-content-center align-items-center gap-3">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="slider-gallery owl-carousel">
                <div class="col-12">
                    <div>
                        <img src="{{ url('/assets/images/slider/1.png') }}" class="img-fluid" alt="" style="height: 320px !important;" />
                    </div>
                </div>
                <div class="col-12">
                    <div>
                        <img src="{{ url('/assets/images/slider/2.png') }}" class="img-fluid" alt="" style="height: 320px !important;" />
                    </div>
                </div>
                <div class="col-12">
                    <div>
                        <img src="{{ url('/assets/images/slider/3.png') }}" class="img-fluid" alt="" style="height: 320px !important;" />
                    </div>
                </div>
                <div class="col-12">
                    <div>
        ...
        <div class="row g-5">
            <div class="col-12 project-container">
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content bg-primary" style="background: url('assets/images/project/1.png');">
                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mt-1 mb-4 d-flex" style="gap: 8px">
                                        <div class="d-flex" style="height: 20px; gap: 12px">
                                            <div>
                                                <img src="{{ url('/assets/images/icon/kamar_tidur.png') }}" alt="" width="15px" height="15px" />
                                            </div>
                                            <div>
                                                <p>2</p>
                                            </div>
                                        ...
                                        <div class="d-flex" style="height: 20px; gap: 8px">
                                            <div>
                                                <img src="{{ url('/assets/images/icon/kamar_mandi.png') }}" alt="" width="15px" height="15px" />
                                            </div>
                                            <div>
                                                <p>1</p>
                                            </div>
                                        ...
                                        <div class="d-flex" style="height: 20px; gap: 8px">
                                            <div>
                                                <img src="{{ url('/assets/images/icon/carport.png') }}" alt="" width="15px" height="15px" />
                                            </div>
                                            <div>
                                                <p>Carport</p>
                                            </div>
                                        ...
                                        <div class="d-flex" style="height: 20px; gap: 8px">
                                            <div>
                                                <img src="{{ url('/assets/images/icon/luas_tanah.png') }}" alt="" width="15px" height="15px" />
                                            </div>
                                            <div>
                                                <p>60m</p>
                                            </div>
                                        ...
                                        <div class="d-flex" style="height: 20px; gap: 8px">
                                            <div>
                                                <img src="{{ url('/assets/images/icon/luas_bangunan.png') }}" alt="" width="15px" height="15px" />
                                            </div>
                                            <div>
                                                <p>30m</p>
                                            </div>
                ...
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content" style="background: url('assets/images/project/2.png');">
                    </div>
                    <div class="project-detail">
                        <div class="container-fluid">
                            <div class="row">
                ...
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content" style="background: url('assets/images/project/3.png');">
                    </div>
                    <div class="project-detail">
                        <div class="container-fluid">
                            <div class="row">
                ...
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content" style="background: url('assets/images/project/4.png');">
                    </div>
                    <div class="project-detail">
                        <div class="container-fluid">
                            <div class="row">
                ...
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content" style="background: url('assets/images/project/5.png');">
                    </div>
                    <div class="project-detail">
                        <div class="container-fluid">
                            <div class="row">
                ...
                <div class="position-relative" style="min-height: 300px">
                    <div class="position-absolute project-content" style="background: url('assets/images/project/6.png');">
                    </div>
                    <div class="project-detail">
                        <div class="container-fluid">
                            <div class="row">
